...
func (tc TestCase_topUp) Run(t *testing.T) {
	_, gotIsTopUp := tc.account.TopUp(tc.amount)
...
func (tc TestCase_withdraw) Run(t *testing.T) {
	_, gotIsTopUp := tc.account.Withdraw(tc.amount)
...
// writing your tests bellow this line

func TestChangingBalance(t *testing.T) {
	var account Account = NewAccount(NewMockTime())

	account, _ = account.TopUp(500)
	account, _ = account.Withdraw(200)
...
func TestStatement(t *testing.T) {
	...
	got := account.Statement()
	want := "2023-03-18 12:34:07 +500 500\n2023-03-18 12:34:37 -200 300"

	if want != got {
		t.Errorf("wrong: want %s, got %s", want, got)
	}
...
func TestOperation(t *testing.T) {
	...
	for i := range want {
		if want[i].OpAmount != got[i].OpAmount {
